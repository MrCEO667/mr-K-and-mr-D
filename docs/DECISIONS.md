...
| 43 | The composer prompt does **not** state the budget caps the gate enforces. | Told "setup under $100, margin at least 3.0", qwen3:8b produced compliant numbers by construction: $20 setup for a term it estimated at $500 when not told, $50 for one it put at $200. Every estimate then sat just inside our thresholds, the gate passed 11 of 11, and the card printed our own config back at the operator with "(est.)" beside it. Same failure as decision 36 -- a number shown to the model is a number it returns. With the caps removed the estimates spread ($20-$150, 2.9x-9.8x) and the gate rejected 2 of 8 for real reasons. Feasibility is judged after the estimate, never supplied before it. |
